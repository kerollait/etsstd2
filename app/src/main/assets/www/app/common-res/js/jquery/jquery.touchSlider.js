...
(function ($) {
	...
	var touchSlider = {
		...
		init : function () {
			...
			this._sti = this.opts.sti;
			this._view = this.opts.view;
			this._speed = this.opts.speed;
			this._tg = $(this);
			this._list = this._tg.children().children();
			this._list_ul = this._tg.children('ul');
			this._list_h =  $(this).children('.comm_slide_h');
			this._list_slide =  $(this).children('.comm_slide_h').children();
			...
			for(var i=0; i<this._len; ++i) {
				...
				this._list_h.css({
					"height" : this._list_slide.innerHeight() + "px"
				});
		...
		resize : function (e) {
			if(e.opts.flexible) {
				...
				for(var i=0; i<e._len; ++i) {
					...
					e._list_h.css({
						"height" : e._list_slide.innerHeight() + "px"
					});
					if(this.opts.supportsCssTransitions && this.opts.transition) {
						e._list.eq(i).css({
							"-moz-transition" : "0ms",
